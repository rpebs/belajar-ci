...
$routes->group('admin', ['filter' => 'adminsAuth'], function ($routes) {
    ...
    $routes->add('categories/new', 'CategoriesController::create');
    $routes->add('categories/(:segment)/edit', 'CategoriesController::edit/$1');
    $routes->get('categories/(:segment)/delete', 'CategoriesController::delete/$1');
});
